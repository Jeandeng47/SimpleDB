...
public class HeapFile implements DbFile {
    ...
    public Page readPage(PageId pid) {
        ...
        // read from file using r mode
        try (RandomAccessFile raf = new RandomAccessFile(f, "r")) {
            // calculate the starting pos to read data
            long offset = (long) pgNo * pgSize;
            raf.seek(offset);
     ...
     */
    public int numPages() {
        // ceiling: remaining data that doesn't completely fill a page, it is still
    ...
    public DbFileIterator iterator(TransactionId tid) {
        // must use BufferPool.getPage() to access page in DbFile
